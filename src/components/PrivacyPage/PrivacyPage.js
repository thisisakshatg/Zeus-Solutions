...
const PrivacyPage = () => {
  return (
    <section className="section-industry-page section-privacy">
      <div className="full-img img-Privacy-Page">
        <Header />
        <section class="section-contact-us">
          <div class="container">
            <h1 className="heading-primary contact-primary">Privacy Policy</h1>
          </div>
        </section>
      </div>
      <div class="container about-div">
        <div class="about-div-1">
          ...
          <p class="feature-text tertiary-industry-page">
            At Zeus Solutions Inc, accessible from www.zeussolutionsinc.com, one
            of our main priorities is the privacy of our visitors. This Privacy
            Policy document contains types of information that is collected and
            recorded by Zeus Solutions Inc and how we use it. If you have
            ...
            collect in Zeus Solutions Inc. This policy is not applicable to any
            information collected offline or via channels other than this
            website. Our Privacy Policy was created with the help of the{' '}
            <a href="privacy-policy-generator" className="privacy-link">
              Free Privacy Policy Generator
            </a>
          </p>
          <br></br>
          <h3 class="heading-tertiary tertiary-industry-page">Consent</h3>
          <p class="feature-text tertiary-industry-page">
          ...
          <p class="feature-text tertiary-industry-page">
            ...
            <br></br>● Provide, operate, and maintain our website<br></br>●
            Improve, personalize, and expand our website<br></br>● Understand
            and analyze how you use our website<br></br>● Develop new products,
            services, features, and functionality<br></br>● Communicate with
            ...
            <br></br>● Send you emails<br></br>● Find and prevent fraud<br></br>
          </p>
          <h3 class="heading-tertiary tertiary-industry-page">Log Files </h3>
          <p class="feature-text tertiary-industry-page">
            Zeus Solutions Inc follows a standard procedure of using log files.
          ...
          <p class="feature-text tertiary-industry-page">
            Like any other website, Zeus Solutions Inc uses ‘cookies’. These
            ...
            browser type and/or other information.<br></br>For more general
            information on cookies, please read the{' '}
            <a
              className="privacy-link"
              href="https://www.termsfeed.com/blog/sample-cookies-policy-template/#What_Are_Cookies"
            >
          ...
          <p class="feature-text tertiary-industry-page">
            ...
            advertising partners of Zeus Solutions Inc.
            <br></br>
            Third-party ad servers or ad networks uses technologies like
            cookies, JavaScript, or Web Beacons that are used in their
            respective advertisements and links that appear on Zeus Solutions
            Inc, which are sent directly to users’ browser. They automatically
            receive your IP address when this occurs. These technologies are
            used to measure the effectiveness of their advertising campaigns
            and/or to personalize the advertising content that you see on
            websites that you visit.<br></br>
            Note that Zeus Solutions Inc has no access to or control over these
          ...
          <p class="feature-text tertiary-industry-page">
            Zeus Solutions Inc’s Privacy Policy does not apply to other
          ...
          <p class="feature-text tertiary-industry-page">
            ...
            business has collected about consumers.<br></br>Request that a
            business delete any personal data about the consumer that a business
            has collected.<br></br>Request that a business that sells a
            consumer’s personal data, not sell the consumer’s personal data.
            <br></br>If you make a request, we have one month to respond to you.
          ...
          <p class="feature-text tertiary-industry-page">
            ...
            believe is incomplete.<br></br>The right to erasure – You have the
            ...
            certain conditions.<br></br>The right to object to processing – You
            have the right to object to our processing of your personal data,
            under certain conditions.<br></br>The right to data portability –
            ...
            conditions.<br></br>If you make a request, we have one month to
          ...
          <p class="feature-text tertiary-industry-page">
            ...
            <br></br>
            Zeus Solutions Inc does not knowingly collect any Personal
